  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center py-2 px-4 justify-between border-b border-bordes">
        ...
        <div>
          <div title="Configuración" className="fill-current text-white rounded-full p-2 hover:bg-bodylight cursor-pointer">
      ...
      <div className="px-5 flex items-center justify-center border-t border-bordes space-x-10" style={{ height: "8%" }}>
